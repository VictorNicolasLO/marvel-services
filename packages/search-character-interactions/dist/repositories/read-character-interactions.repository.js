...
let ReadCharacterInteractionsRepository = class ReadCharacterInteractionsRepository extends infrastructure_1.GenericQueryKeyValueRepository {
    constructor(ep) {
        super(new infrastructure_1.RedisDriver("read-character-interactions"));
        this.ep = ep;
    }
};
ReadCharacterInteractionsRepository = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [infrastructure_1.AppEventPublisher])
], ReadCharacterInteractionsRepository);
exports.ReadCharacterInteractionsRepository = ReadCharacterInteractionsRepository;
//# sourceMappingURL=read-character-interactions.repository.js.map