...
exports.kafkaConfig = exports.defaultReplyConsumerconfig = exports.defaultConsumerSubscriberConfig = exports.defaultConsumerConfig = exports.defaultClientConfig = exports.defaultRequestTopic = exports.defaultReplyTopic = exports.defaultEventTopicConfig = void 0;
...
exports.defaultConsumerSubscriberConfig = (groupId) => ({
    groupId: groupId + "-kafkajs-v2",
});
